...
<div class="container" style="max-width: 800px;">
    ...
    <div class="mb-4">
        ...
        <h1 class="fw-bold text-dark mt-2 mb-1">Publikasikan Lowongan Kerja</h1>
        <p class="text-muted">Masukkan kriteria kebutuhan pelamar kerja untuk posisi ini</p>
    </div>
    ...
    <form action="{{ route('company.job-postings.store') }}" method="POST">
        ...
        <div class="mb-5 d-flex gap-2">
            <button type="submit" class="btn btn-primary rounded-pill px-5 fw-bold py-2.5">Publikasikan Lowongan</button>
